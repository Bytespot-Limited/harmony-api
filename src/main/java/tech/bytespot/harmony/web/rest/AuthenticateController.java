...
import static tech.bytespot.harmony.security.SecurityUtils.AUTHORITIES_KEY;
import static tech.bytespot.harmony.security.SecurityUtils.JWT_ALGORITHM;
...
import tech.bytespot.harmony.web.rest.vm.LoginResponse;
import tech.bytespot.harmony.web.rest.vm.LoginVM;
...
public class AuthenticateController {
  ...
  public ResponseEntity<LoginResponse> authorize(@Valid @RequestBody LoginVM loginVM) {
    ...
    response.setMessage("User token generated successfully");
