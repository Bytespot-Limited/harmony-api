...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof tech.bytespot.harmony.service.EmailAlreadyUsedException ||
            ex instanceof tech.bytespot.harmony.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof tech.bytespot.harmony.service.InvalidPasswordException
